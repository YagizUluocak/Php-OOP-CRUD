                                ...
                                <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="takim_twitter" name="takim_twitter">
                                        </div>
                                        <div class="mb-3">
                                            <label for="takim_instagram" class="form-label"> <h6 style="color: black;">İnstagram</h6></label>
                                            <input type="text" class="form-control" id="takim_instagram" name="takim_instagram">
                                        </div>
                                        <div class="mb-3">
                                            <label for="takim_linkedin" class="form-label"><h6 style="color: black;">Linkedin</h6></label>
                                            <input type="text" class="form-control" id="takim_linkedin" name="takim_linkedin">
                                        </div>
