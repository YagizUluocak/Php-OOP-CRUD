                ...
                <div class="bg-light rounded p-4" style="height: 100%;">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                          ...
                          <input class="form-control bg-dark" type="text" id="yonetici_adsoyad" name="yonetici_adsoyad">
                        </div>
                        <div class="mb-3">
                          <label for="yonetici_mail" class="form-label"><h6 style="color: black;">Mail</h6></label>
                          <input type="text" class="form-control" id="yonetici_mail" name="yonetici_mail">
                        </div>
                        <div class="mb-3">
                          <label for="yonetici_username" class="form-label"><h6 style="color: black;">Username</h6></label>
                          <input type="text" class="form-control" id="yonetici_username" name="yonetici_username">
                        </div>
                        <div class="mb-3">
                          <label for="yonetici_password" class="form-label"><h6 style="color: black;">Password</h6></label>
                          <input type="text" class="form-control" id="yonetici_password" name="yonetici_password">
                        </div>
